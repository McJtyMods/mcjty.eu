...
| structure                                                             | `S/[S]`      |         | V     | V      | V    | V   | V       | V         | V          | V     | V      | the name of the structure to test for. This way you can make sure a rule only fires in a village for example. Some examples are `minecraft:mineshaft`, `minecraft:village`, and so on. Modded structures should also work. On 1.19 only you can use a list in this test                                                                                                                               |
| structuretags                                                         | `S/[S]`      |         | V     | V      | V    | V   | V       | V         | V          | V     | V      | the name of the structure tag to test for. This way you can make sure a rule only fires in a village for example. Some examples are `minecraft:mineshaft`, `minecraft:village`, and so on. Modded structures should also work. Only on 1.19                                                                                                                                                           |
| hasstructure                                                          | `B`          |         | V     | V      | V    | V   | V       | V         | V          | V     | V      | test if we are in any structure. Only on 1.19                                                                                                                                                                                                                                                                                                                                                         |
